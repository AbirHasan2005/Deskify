...
printf "\n\n\e[1;92mVNC Server Starting ...\nOpen VNC Viewer and add new connection type address '127.0.0.1:1' give the name to machine like 'Windows 7' and click on create and then on connect. After connection enjoys the system.\n\n"
